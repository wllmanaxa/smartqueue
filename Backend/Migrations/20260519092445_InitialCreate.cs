        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    AverageHandlingMinutes = table.Column<int>(type: "integer", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Counters_Users_StaffUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CounterServices", x => new { x.CountersId, x.ServicesId });
                    table.ForeignKey(
                        name: "FK_CounterServices_Counters_CountersId",
                        column: x => x.CountersId,
                        principalTable: "Counters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CounterServices_Services_ServicesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QueueLogs_Tickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "Tickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QueueLogs_Users_PerformedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Counters_BranchId_Number",
                table: "Counters",
                columns: new[] { "BranchId", "Number" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Counters_StaffUserId",
                table: "Counters",
                column: "StaffUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CounterServices_ServicesId",
                table: "CounterServices",
                column: "ServicesId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QueueLogs_CreatedAt",
                table: "QueueLogs",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_QueueLogs_PerformedByUserId",
                table: "QueueLogs",
                column: "PerformedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_QueueLogs_TicketId",
                table: "QueueLogs",
                column: "TicketId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_BranchId_Code",
                table: "Services",
                columns: new[] { "BranchId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Tickets_BranchId_TicketNumber",
                table: "Tickets",
